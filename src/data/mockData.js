...
export const mockJobs = [
  ...
  },
  {
    ...
    location: "TP.HCM",
    salary: "10-16 triệu",
    description: "Tối ưu hóa website và nội dung để tăng thứ hạng trên công cụ tìm kiếm",
    requirements: ["Hiểu biết SEO", "Google Analytics", "Viết nội dung"],
    disabilityTypes: ["Vận động", "Khiếm thính"],
    severityLevel: "Nhẹ",
    status: "active",
    employerAvatar: "👨‍💻",
  ...
  {
    id: 10,
    title: "Nhân viên kiểm thử phần mềm",
    company: "Quality Assurance Inc",
    location: "Hà Nội",
    salary: "12-18 triệu",
    description: "Kiểm thử và đảm bảo chất lượng phần mềm trước khi phát hành",
    requirements: ["Kinh nghiệm QA", "Test case", "Báo cáo lỗi"],
    disabilityTypes: ["Vận động"],
    severityLevel: "Trung bình",
    status: "active",
    employerAvatar: "👩‍💻",
  },
  {
    ...
    location: "Đà Nẵng",
    salary: "7-12 triệu",
    description: "Tư vấn và bán hàng qua các kênh online như chat, email, mạng xã hội",
    requirements: ["Giao tiếp tốt", "Hiểu biết sản phẩm", "Máy tính cơ bản"],
  ...
  },
  {
    ...
    location: "TP.HCM",
    salary: "8-13 triệu",
    description: "Quản lý và phát triển nội dung cho các trang mạng xã hội của công ty",
    requirements: ["Hiểu biết mạng xã hội", "Sáng tạo nội dung", "Photoshop cơ bản"],
    disabilityTypes: ["Vận động", "Khiếm thính"],
    severityLevel: "Nhẹ",
    status: "active",
    employerAvatar: "👩‍💼",
  },
  {
    ...
    location: "Hà Nội",
    salary: "9-14 triệu",
    description: "Hỗ trợ khách hàng giải quyết các vấn đề kỹ thuật qua email và chat",
    requirements: ["Kiến thức kỹ thuật", "Giao tiếp tốt", "Kiên nhẫn"],
    disabilityTypes: ["Vận động"],
    severityLevel: "Nhẹ",
    status: "active",
    employerAvatar: "👨‍💻",
  },
  {
    ...
    company: "Market Research Group",
    location: "TP.HCM",
    salary: "11-17 triệu",
    description: "Thu thập và phân tích dữ liệu thị trường để đưa ra các báo cáo và đề xuất",
    requirements: ["Phân tích dữ liệu", "Excel tốt", "Tư duy logic"],
    disabilityTypes: ["Vận động", "Khiếm thính"],
    severityLevel: "Nhẹ",
    status: "active",
    employerAvatar: "👩‍💼",
  ...
  {
    id: 15,
    title: "Nhân viên đào tạo trực tuyến",
    company: "Online Education Platform",
    location: "Đà Nẵng",
    salary: "10-15 triệu",
    description: "Tạo và quản lý các khóa học trực tuyến, hỗ trợ học viên",
    requirements: ["Kỹ năng giảng dạy", "Công nghệ e-learning", "Giao tiếp tốt"],
    disabilityTypes: ["Vận động", "Khiếm thị"],
    severityLevel: "Trung bình",
    status: "active",
    employerAvatar: "👨‍🏫",
  },
  {
    ...
    location: "Hà Nội",
    salary: "15-22 triệu",
    description: "Quản lý và điều phối các dự án, đảm bảo tiến độ và chất lượng công việc",
    requirements: ["Kinh nghiệm quản lý", "Kỹ năng tổ chức", "Giao tiếp tốt"],
    disabilityTypes: ["Vận động"],
    severityLevel: "Nhẹ",
    status: "active",
    employerAvatar: "👩‍💼",
